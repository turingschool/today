...
Stay in A where we'll start talking about [Headcount](https://github.com/turingschool/curriculum/blob/master/source/projects/headcount.markdown). You'll complete the project in these pairs:
