...
Join Rachel in Classroom B to 

### Traffic Spy Kickoff (9:30 - 10:30)

Join Rachel in Classroom B to kick off your first project, [Traffic Spy](https://github.com/turingschool/curriculum/blob/master/source/projects/traffic_spy.markdown).
...
Join Josh Cheek (he's back!) in Classroom B for a look at ActiveRecord. 
