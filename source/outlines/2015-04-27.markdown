...
### Advanced ActiveRecord and Perf Workshop (9:00 - 12:00)

This will be a group session with 1410 to finish up some of the query topics we started last week and then work through a project to apply some of the performance topics we've been discussing. See the notes under 1410's section above for more info.
