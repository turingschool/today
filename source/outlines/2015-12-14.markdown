...
* Afterwards we'll walk through how to hack our way into [adding Sinon to the game-time-starter-kit](https://gist.github.com/rrgayhart/cf5dcefdf3975598f491) and see an example of using Sinon to [test a game](https://github.com/turingschool-examples/sinon-and-event-gametime).
