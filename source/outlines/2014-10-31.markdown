...
This afternoon, please _respect the Friday_ and do not work on your project. You should, instead, choose one or more of the following:
...
* Is there something you wish was included in a tutorial? Open a pull request or a new issue.
...
* Level up your git skills with [Try Git](https://try.github.io/levels/1/challenges/1).
* Try out a visual git tool like [Github for Mac][ghfm] or [GitX][gitx].
...
* 1409 will meet in Classroom B and be joined by Jeff
* 1410 will meet in Classroom C and be joined by Rachel and Josh Mejia
