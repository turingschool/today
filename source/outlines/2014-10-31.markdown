...
* Interested in playing with [Docker][docker] or [Panamax][panamax]? How about seeing if we can't get a safe Ruby environment to evaulate code in? Jonmichael has already opened up an issue [here][docker-sandbox].
